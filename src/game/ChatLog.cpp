...
void ChatLog::ChatBadLexicsAction(Player* player, std::string& msg)
{
    ...
    switch (LexicsCutterAction)
    {
        ...
        case LEXICS_ACTION_DIE:
        {
            ...
            // player->DealDamage(player, player->GetHealth(), NULL, DIRECT_DAMAGE, SPELL_SCHOOL_NORMAL, NULL, 0, false);
        }
        break;
        ...
        {
            // living corpse :)
            // player->DealDamage(player, player->GetHealth() - 5, NULL, DIRECT_DAMAGE, SPELL_SCHOOL_NORMAL, NULL, 0, false);
        }
        break;
